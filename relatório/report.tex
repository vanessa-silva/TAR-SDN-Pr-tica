...
\title{Trabalho Prático - SDN}

\author{Remi Dias\\
  \href{mailto:up201105074@fc.up.pt}{\texttt{up201105074@fc.up.pt}}\\
  Vanessa Silva\\
  \href{mailto:up201305731@fc.up.pt}{\texttt{up201305731@fc.up.pt}}\\
\multicolumn{1}{p{.7\textwidth}}{\centering\emph{
\\Tópicos Avançados em Redes,\\Departamento de Ciências de Computadores,\\Faculdade de Ciências da Universidade do Porto}}
}
\date{\today}
%\titlepic{
%}
